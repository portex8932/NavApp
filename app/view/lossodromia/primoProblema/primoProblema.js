...
Δϕ Crescente: ${deltaPhiCre}' ${letteraDeltaPhi}
ϕ Crescente Arrivo: ${latitudeArrCre}' ${letteraLatArr}
ϕ Crescente Partenza: ${latitudeCre}' ${letteraLat}
Δλ: ${deltaLambda}° ${letteraDeltaLambda}`;
            }else{
                risultati.text=`Latitudine Arrivo: ${gradiLatArr}° ${primiLatArr}' ${letteraLatArr}
Longitudine Arrivo: ${gradiLonArr}° ${primiLonArr}' ${letteraLonArr}
ΔΨ: ${deltaPsi}'
Ψ Partenza: ${gradiLatGeo}° ${primiLatGeo} ${letteraLat}
Ψ Arrivo: ${gradiLatGeoArr}° ${primiLatGeoArr}' ${letteraLatArr}`;
            }
            break;
        case 1:
            risultati.text=` `;
