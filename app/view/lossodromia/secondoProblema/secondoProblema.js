...
function Cammino(){
    cammino = (deltaPsi*60)/Math.cos(Rad2Deg(rottaVeraQuadrantale));
...
function SetOutput(){
    switch (bug){
        case 0:
            if (eccentricita===0){
                latitudeCre=latitudeCre/60;
                latitudeArrCre=latitudeArrCre/60;
...
ϕ Crescente Partenza: ${gradiLatCre}° ${primiLatCre.toFixed(5)}' ${letteraLat}
ϕ Crescente Arrivo: ${gradiLatCreArr}° ${primiLatArrCre.toFixed(5)}' ${letteraLatArr}`;
